...
import 'package:touristine/WebApplication/Profiles/Tourist/MainPages/Home/complaints.dart';
          ...
          ScrollbarTheme(
            ...
            child: Scrollbar(
              ...
              child: Container(
                ...
                child: Padding(
                  padding:
                      const EdgeInsets.only(left: 13.0, right: 20, top: 10),
                  child: ListView(
                    controller: scrollController,
                    children: [
                      Row(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      getBudgetLevel(widget
                                          .destinationDetails['CostLevel']),
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontFamily: 'Time New Roman',
                                        fontSize: 25,
